    ...
    // <div className="relative min-h-auto bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <svg viewBox="0 0 1200 800" className="w-full h-full">
          ...
          <rect x="100" y="400" width="60" height="200" fill="#4A90E2" opacity="0.6"/>
          <rect x="180" y="350" width="80" height="250" fill="#5BA0F2" opacity="0.7"/>
          <rect x="280" y="300" width="70" height="300" fill="#6BB0FF" opacity="0.6"/>
          <rect x="370" y="380" width="90" height="220" fill="#4A90E2" opacity="0.8"/>
          <rect x="480" y="320" width="75" height="280" fill="#5BA0F2" opacity="0.7"/>
          <rect x="580" y="360" width="85" height="240" fill="#6BB0FF" opacity="0.6"/>
          <rect x="690" y="290" width="95" height="310" fill="#4A90E2" opacity="0.8"/>
          <rect x="810" y="340" width="80" height="260" fill="#5BA0F2" opacity="0.7"/>
          
          {/* Windows on buildings */}
          <rect x="110" y="420" width="8" height="8" fill="#FFF" opacity="0.8"/>
          <rect x="125" y="420" width="8" height="8" fill="#FFF" opacity="0.8"/>
          <rect x="140" y="420" width="8" height="8" fill="#FFF" opacity="0.8"/>
          <rect x="110" y="440" width="8" height="8" fill="#FFF" opacity="0.8"/>
          <rect x="125" y="440" width="8" height="8" fill="#FFF" opacity="0.8"/>
          <rect x="140" y="440" width="8" height="8" fill="#FFF" opacity="0.8"/>
          
          {/* More windows on other buildings */}
          <rect x="200" y="370" width="10" height="10" fill="#FFF" opacity="0.8"/>
          <rect x="220" y="370" width="10" height="10" fill="#FFF" opacity="0.8"/>
          <rect x="240" y="370" width="10" height="10" fill="#FFF" opacity="0.8"/>
          <rect x="200" y="390" width="10" height="10" fill="#FFF" opacity="0.8"/>
          <rect x="220" y="390" width="10" height="10" fill="#FFF" opacity="0.8"/>
          <rect x="240" y="390" width="10" height="10" fill="#FFF" opacity="0.8"/>
        </svg>
      </div>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl font-bold text-[#222222] leading-tight">
                Ezone Solutions<br />
                <span className="text-[#222222]">Automates Business Processes.</span>
              </h1>
              
              <p className="text-xl text-[#222222] leading-relaxed ">
                This innovative business Solution powered with AI will turn your 
                business around. It's built for efficiency, transparency and improved 
                turn around time.
              </p>
            </div>
